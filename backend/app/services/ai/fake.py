"""In-package FakeAIService — mirrors tests/fake_ai.py for runtime use."""
...
class FakeAIService(AIService):
    ...
    async def grade_typed_answer(self, question: str, correct_answer: str, user_answer: str) -> GradingResult:
